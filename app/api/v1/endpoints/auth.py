...
# Load terms and privacy policy markdown from external file
current_dir = os.path.dirname(os.path.abspath(__file__))
app_dir = os.path.dirname(os.path.dirname(os.path.dirname(current_dir)))
terms_file_path = os.path.join(app_dir, "assets", "terms_privacy.md")

try:
    with open(terms_file_path, "r", encoding="utf-8") as f:
        TERMS_PRIVACY_MARKDOWN = f.read()
except Exception as e:
    logger.error(f"Failed to load terms_privacy.md: {e}")
    TERMS_PRIVACY_MARKDOWN = ""
